...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: 'لماذا تعتبر أنظمة السلامة ضرورية لمنشأتي؟',
      answer: 'السلامة ليست خياراً بل ضرورة لحماية الأرواح والممتلكات. أنظمتنا المعتمدة تضمن الكشف المبكر والتعامل الفعال مع المخاطر، مما يقلل الخسائر ويحقق الامتثال للمعايير المحلية.'
    },
    {
      question: 'هل عقود الصيانة لديكم معتمدة؟',
      answer: 'نعم، نقدم عقود صيانة سنوية ودورية معتمدة من الدفاع المدني والجهات المختصة، لضمان جاهزية وفعالية أنظمة الإطفاء والإنذار في جميع الأوقات.'
    },
    {
      question: 'ما هي أنواع أنظمة الإطفاء التي تقومون بتنفيذها؟',
      answer: 'نقوم بتنفيذ وصيانة مجموعة واسعة من الأنظمة تشمل: الرش الآلي، خراطيم الحريق، أنظمة الإطفاء بالغاز (FM200, CO2)، ومضخات الحريق المتطورة.'
    },
    {
      question: 'هل تغطون مشاريع المقاولات خارج مدينة تبوك؟',
      answer: 'نعم، نتوسع في مشاريعنا لتشمل مختلف مناطق المملكة، مع الالتزام بأحدث تقنيات البناء والممارسات الهندسية المستدامة لتقديم حلول بنية تحتية عالية الجودة.'
    },
    {
      question: 'كيف يمكنني البدء في طلب خدمة أو عرض سعر؟',
      answer: 'يمكنك التواصل معنا عبر الموقع، أو الاتصال المباشر، أو زيارة مقرنا الرئيسي. سنقوم بدراسة احتياجاتك وتقديم عرض فني ومالي يتناسب مع متطلبات مشروعك.'
    }
  ];
